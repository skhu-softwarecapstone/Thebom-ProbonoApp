...
public class RecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.spon_page_fragment_recyclerviewpager, container, false);
        recyclerView = (RecyclerView)view.findViewById(R.id.spon_recyclerView);
        movieList = new ArrayList<>();


        SponNetworkTaskHandler networkTaskHandler = new SponNetworkTaskHandler(url, null, recyclerView, view);
