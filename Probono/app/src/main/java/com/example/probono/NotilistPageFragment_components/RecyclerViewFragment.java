package com.example.probono.NotilistPageFragment_components;
        ...
        import com.example.probono.DAO.NetworkTask.NotiNetworkTaskHandler;
...
public class RecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.notilist_page_fragment_recyclerviewpager, container, false);
        recyclerView = (RecyclerView)view.findViewById(R.id.noti_recyclerView);
        movieList = new ArrayList<>();


        NotiNetworkTaskHandler networkTaskHandler = new NotiNetworkTaskHandler(url, null, recyclerView, view);
